...
- We can host github using gitlab
...
* Jenkins 
- Jenkins 
  - installation [using executable, java -jar, tomcat -war, inside VM Vagrant, inside containers Docker]
...
Note: only java 8 is able to link with jenkins not default-java or java 11....etc
